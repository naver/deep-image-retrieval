...
class InceptionResNetV2(nn.Module):
    ...
    def __init__(self, fc_out):
        ...
        self.rgb_means = [0.5, 0.5, 0.5]
        self.rgb_stds  = [0.5, 0.5, 0.5]
        self.input_size = (3, 229, 229)
        # Modules
        ...
        self.conv2d_7b = BasicConv2d(2080, self.fc_in, kernel_size=1, stride=1)
        self.last_linear = None
        if self.fc_out > 0:
            self.avgpool_1a = nn.AvgPool2d(8, count_include_pad=False)
            self.last_linear = nn.Linear(self.fc_in, self.fc_out)
