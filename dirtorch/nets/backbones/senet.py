...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, fc_out, model_name, dropout_p=0.2,
...
def senet154(out_dim=2048):
    model = SENet(SEBottleneck, [3, 8, 36, 3], groups=64, reduction=16,
                  dropout_p=0.2, fc_out=out_dim, model_name='senet154')
    return model


def se_resnet50(out_dim=2048):
    model = SENet(SEResNetBottleneck, [3, 4, 6, 3], groups=1, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  fc_out=out_dim, model_name='se_resnet50')
    return model


def se_resnet101(out_dim=2048):
    model = SENet(SEResNetBottleneck, [3, 4, 23, 3], groups=1, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  fc_out=out_dim, model_name='se_resnet101')
    return model


def se_resnet152(out_dim=2048):
    model = SENet(SEResNetBottleneck, [3, 8, 36, 3], groups=1, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  fc_out=out_dim, model_name='se_resnet152')
    return model


def se_resnext50_32x4d(out_dim=2048):
    model = SENet(SEResNeXtBottleneck, [3, 4, 6, 3], groups=32, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  fc_out=out_dim, model_name='se_resnext50_32x4d')
    return model


def se_resnext101_32x4d(out_dim=2048):
    model = SENet(SEResNeXtBottleneck, [3, 4, 23, 3], groups=32, reduction=16,
                  dropout_p=None, inplanes=64, input_3x3=False,
                  downsample_kernel_size=1, downsample_padding=0,
                  fc_out=out_dim, model_name='se_resnext101_32x4d')
    return model
